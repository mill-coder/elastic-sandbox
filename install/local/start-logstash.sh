...
# ---------------------------------------------------------------------------
# start-logstash.sh — Start Elastic stack with Logstash profile
...
log "Starting Elastic stack with Logstash"
log "  Compose file: $COMPOSE_FILE"
log "  Env file:     $ENV_FILE"
log "  Profiles:     kibana, logstash"
